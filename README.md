## <div align="center">YOLOv5 trained on BDD100k</div>

<details>

<summary>Dataset preparation</summary>

Download the BDD100k `100k images` and `Detection 2020 labels` from the [official website](https://bdd-data.berkeley.edu/), unpack it into your yolov5 dataset directory into the structure below.
Then go to `data/scripts` and run `python bdd_to_yolo.py` to convert the dataset into YOLO format.
    ...
    bdd_yolo
        ...
        labels
            det_20
                det_train.json
                det_val.json
            train  <-- generated by bdd_to_yolo.py
            val    <-- generated by bdd_to_yolo.py
```
...
We train yolov5s on two TitanRTX GPUs for 300 epochs using the COCO pretrained model. We use an image size of 1280 x 1280 pixel to increase the models ability to detect small objects.

```bash
python -m torch.distributed.run --nproc_per_node 2 train.py --img 1280 --batch 64 --data ./data/bdd.yaml --epochs 300 --weights yolov5s.pt --device 0,1
```
...
```bash
python detect.py --weights <path to trained model> --img 1280 --source 0                               # webcam
                                                                       img.jpg                         # image
                                                                       vid.mp4                         # video
                                                                       screen                          # screenshot
                                                                       path/                           # directory
...
```
 We provide a trained model for [download](https://drive.google.com/file/d/1F9IRMT8OrnKcUXhOzNJr6HyFtxSkgspz/view?usp=sharing).
...
- [yolov5s_bdd100k](https://github.com/williamhyin/yolov5s_bdd100k)

</details>


---
## <div align="center">Original YOLOv5 README</div>
...
For YOLOv5 bug reports and feature requests please visit [GitHub Issues](https://github.com/ultralytics/yolov5/issues), and join our [Discord](https://discord.gg/bNc8wwx7Qy) community for questions and discussions!
