...
class VOC:
    ...
    def save(xml_list, path):
        ...
        try:
            ...
            progress_cnt = 0
            printProgressBar(0, progress_length, prefix='\nVOC Save:'.ljust(10), suffix='Complete',
                             length=40)
            ...
            for key in xml_list:
                ...
                printProgressBar(progress_cnt + 1, progress_length, prefix='VOC Save:'.ljust(15),
                                 suffix='Complete', length=40)
                progress_cnt += 1
    ...
    def parse(path):
        try:
            ...
            for filename in filenames:
                ...
                printProgressBar(progress_cnt + 1, progress_length, prefix='VOC Parsing:'.ljust(15),
                                 suffix='Complete', length=40)
                progress_cnt += 1
    ...
    def parse(csv_path, img_path):
        ...
        try:
            ...
            for line in csv_f:
                ...
                printProgressBar(progress_cnt + 1, progress_length,
                                 prefix='UDACITY Parsing:'.ljust(15), suffix='Complete',
                                 length=40)
                progress_cnt += 1
        ...
        try:
            with open("box_groups.txt", "w") as bboxGroups:
                ...
                for filename in filenames:
                    ...
                    printProgressBar(progress_cnt + 1, progress_length,
                                     prefix='KITTI Parsing:'.ljust(15), suffix='Complete',
                                     length=40)
                    progress_cnt += 1
    ...
    def parse(self, label_path, img_path, img_type=".png"):
        try:
            ...
            for filename in filenames:
                ...
                printProgressBar(progress_cnt + 1, progress_length,
                                 prefix='YOLO Parsing:'.ljust(15), suffix='Complete',
                                 length=40)
                progress_cnt += 1
    ...
    def save(self, data, save_path, img_path, img_type, manipast_path):
        ...
        try:
            ...
            with open(manipast_path, "w") as manipast_file:
                for key in data:
                    manipast_file.write(
                        os.path.abspath(os.path.join(img_path, "".join([key, img_type, "\n"]))))

                    with open(os.path.abspath(os.path.join(save_path, "".join([key, ".txt"]))),
                              "w") as output_txt_file:
